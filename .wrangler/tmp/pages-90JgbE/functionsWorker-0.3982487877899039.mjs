...
IP Address: ${context.request.headers.get("cf-connecting-ip") || "Unknown"}
    ...
    mailgunFormData.append("subject", `\u{1F4E7} New Contact from ${firstName} ${lastName}`);
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
    <h1 style="color: white; margin: 0; font-size: 24px;">\u{1F3AF} Nieuwe Demo Aanvraag</h1>
  </div>
  <div style="background: #f9f9f9; padding: 30px; border-radius: 0 0 10px 10px;">
    ...
    notificationFormData.append("subject", `\u{1F3AF} Nieuwe Demo Aanvraag van ${firstName} ${lastName}`);
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="text-align: center; padding: 20px; color: #666; font-size: 12px;">
    <p>\xA9 2025 Tesoro CRM. Alle rechten voorbehouden.</p>
  </div>
</body>
</html>`;
...
// ../.wrangler/tmp/pages-90JgbE/functionsRoutes-0.11340462048775835.mjs
var routes = [
  {
...
// ../../../../../../Users/johnstevens/.nvm/versions/node/v22.19.0/lib/node_modules/wrangler/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../../Users/johnstevens/.nvm/versions/node/v22.19.0/lib/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../../../../../Users/johnstevens/.nvm/versions/node/v22.19.0/lib/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../../../Users/johnstevens/.nvm/versions/node/v22.19.0/lib/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-GxM327/middleware-insertion-facade.js
...
// ../../../../../../Users/johnstevens/.nvm/versions/node/v22.19.0/lib/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-GxM327/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.3982487877899039.mjs.map
